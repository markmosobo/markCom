                                ...
                                <div class="product-details-img">
                                    <div class="product-thumb">
                                        <div id="gallery" class="product-dec-slider-2 product-tab-left">
                                            <a data-image="{{asset('assets/images/product-detail-page/cape-dress-2.jpg')}}" data-zoom-image="{{asset('assets/images/product-detail-page/cape-dress-2.jpg')}}" class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" src="{{$product['imageUrl']}}" alt="" />
                                            </a>
                                            <!-- <a data-image="{{asset('assets/images/product-detail-page/cape-dress-2.jpg')}}" data-zoom-image="{{asset('assets/images/product-detail-page/cape-dress-2.jpg')}}" class="slick-slide slick-cloned" data-slick-index="-3" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" src="{{asset('assets/images/product-detail-page/cape-dress-2.jpg')}}" alt="" />
                                            </a>
                                            <a data-image="{{asset('assets/images/product-detail-page/cape-dress-3.jpg')}}" data-zoom-image="{{asset('assets/images/product-detail-page/cape-dress-3.jpg')}}" class="slick-slide slick-cloned" data-slick-index="-2" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" src="{{asset('assets/images/product-detail-page/cape-dress-3.jpg')}}" alt="" />
                                            </a>
                                            <a data-image="{{asset('assets/images/product-detail-page/cape-dress-4.jpg')}}" data-zoom-image="{{asset('assets/images/product-detail-page/cape-dress-4.jpg')}}" class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" src="{{asset('assets/images/product-detail-page/cape-dress-4.jpg')}}" alt="" />
                                            </a>
                                            <a data-image="{{asset('assets/images/product-detail-page/cape-dress-5.jpg')}}" data-zoom-image="{{asset('assets/images/product-detail-page/cape-dress-5.jpg')}}" class="slick-slide slick-cloned" data-slick-index="0" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" src="{{asset('assets/images/product-detail-page/cape-dress-5.jpg')}}" alt="" />
                                            </a>
                                            <a data-image="{{asset('assets/images/product-detail-page/cape-dress-6.jpg')}}" data-zoom-image="{{asset('assets/images/product-detail-page/cape-dress-6.jpg')}}" class="slick-slide slick-cloned" data-slick-index="1" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" src="{{asset('assets/images/product-detail-page/cape-dress-6.jpg')}}" alt="" />
                                            </a>
                                            <a data-image="{{asset('assets/images/product-detail-page/cape-dress-7.jpg')}}" data-zoom-image="{{asset('assets/images/product-detail-page/cape-dress-7.jpg')}}" class="slick-slide slick-cloned" data-slick-index="2" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" src="{{asset('assets/images/product-detail-page/cape-dress-7.jpg')}}" alt="" />
                                            </a> -->
                                        </div>
                                    </div>
                                    <div class="zoompro-wrap product-zoom-right pl-20">
                                        <div class="zoompro-span">
                                            <img class="zoompro blur-up lazyload" data-zoom-image="{{$product['imageUrl']}}" alt="" src="{{$product['imageUrl']}}" />
                                        </div>
                                    ...
                                    <div class="lightboximages">
                                        <a href="{{$product['imageUrl']}}" data-size="1462x2048"></a>
                                        <!-- <a href="{{asset('assets/images/product-detail-page/cape-dress-2.jpg')}}" data-size="1462x2048"></a>
                                        <a href="{{asset('assets/images/product-detail-page/cape-dress-3.jpg')}}" data-size="1462x2048"></a>
                                        <a href="{{asset('assets/images/product-detail-page/cape-dress-4.jpg')}}" data-size="1462x2048"></a>
                                        <a href="{{asset('assets/images/product-detail-page/cape-dress-5.jpg')}}" data-size="1462x2048"></a>
                                        <a href="{{asset('assets/images/product-detail-page/cape-dress-6.jpg')}}" data-size="1462x2048"></a>
                                        <a href="{{asset('assets/images/product-detail-page/cape-dress-7.jpg')}}" data-size="731x1024"></a> -->
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="product-single__meta">
                                        ...
                                        <div class="prInfoRow">
                                            ...
                                            <div class="product-stock"> <span class="instock ">In Stock</span> @else<span class="outstock hide">Unavailable</span> @endif</div>
                                            <div class="product-sku"><span class="variant-sku">{{$product['category']}}</span></div>
                                            <div class="product-review"><a class="reviewLink" href="#tab2"><i class="font-13 fa fa-star"></i><i class="font-13 fa fa-star"></i><i class="font-13 fa fa-star"></i><i class="font-13 fa fa-star-o"></i><i class="font-13 fa fa-star-o"></i><span class="spr-badge-caption">6 reviews</span></a></div>
                                        </div>
                                        <p class="product-single__price product-single__price-product-template">
                                            <span class="visually-hidden">Regular price</span>
                                            <!-- <s id="ComparePrice-product-template"><span class="money">KSH600.00</span></s> -->
                                            <span class="product-price__price product-price__price-product-template product-price__sale product-price__sale--single">
                                                <span id="ProductPrice-product-template"><span class="money">KSH{{$product['price']}}.00</span></span>
                                            </span>
                                            <!-- <span class="discount-badge"> <span class="devider">|</span>&nbsp;
                                                <span>You Save</span>
                                                <span id="SaveAmount-product-template" class="product-single__save-amount">
                                                <span class="money">KSH100.00</span>
                                                </span>
                                        ...
                                        <div class="orderMsg" data-user="23" data-time="24">
                                            <!-- <img src="{{asset('assets/images/order-icon.jpg')}}" alt="" /> -->
                                              sold by <strong class="time">{{$product['userName']}}</strong></div>
                                        </div>
                                    ...
                                    @else
                                        <!-- <div id="quantity_message">Hurry! Only  <span class="items">{{$product['quantity']}}</span>  left in stock.</div> -->
                                    @endif
                                    <form method="post" action="{{url('addtocart')}}" id="product_form_10508262282" accept-charset="UTF-8" class="product-form product-form-product-template hidedropdown" enctype="multipart/form-data">
                                        ...
                                        <div class="product-action clearfix">
                                            ...
                                            <div class="product-form__item--submit" data-shopify="payment-button">
