                ...
                <div id="ProductSection-product-template" class="product-template__container prstyle1 container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="product-single__meta">
                                        <h1 class="product-single__title">Service Layout Style1</h1>
                                    ...
                                    <form method="post" action="http://annimexweb.com/cart/add" id="product_form_10508262282" accept-charset="UTF-8" class="product-form product-form-product-template hidedropdown" enctype="multipart/form-data">
                                        ...
                                        <p class="infolinks">
                                        <a href="#productInquiry" class="emaillink btn"> Ask About this Service</a>
                                        </p>
                                        <!-- Product Action -->
                                        <div class="product-action clearfix">

                                            <div class="shopify-payment-button" data-shopify="payment-button">
                                                <button type="button" class="shopify-payment-button__button shopify-payment-button__button--unbranded">Book it now</button>
                                            </div>
                                        </div>
                                        <!-- End Product Action -->
                                    </form>
                                    ...
                                    <div class="userViewMsg" data-user="20" data-time="11000"><i class="fa fa-users" aria-hidden="true"></i> <strong class="uersView">14</strong> PEOPLE ARE LOOKING FOR THIS SERVICE</div>
                                </div>
                        </div>
                    </div>
                    <!--End-product-single-->
                    ...
                    <div class="tabs-listing">
                        <ul class="product-tabs">
                            <li rel="tab1"><a class="tablink">Service Details</a></li>
                            <li rel="tab2"><a class="tablink">Service Reviews</a></li>
